...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            platform::inspect_component_package,
            platform::trust_component_package_publisher,
            platform::get_presentation_template_preview,
            platform::list_interface_templates,
            platform::get_interface_template_preview,
            platform::duplicate_interface_template_for_development,
            platform::export_interface_template_package,
            platform::validate_interface_layout,
            platform::install_component_from_package,
            platform::disable_component,
            platform::enable_component,
            platform::delete_component,
            platform::uninstall_component,
            platform::reinstall_bundled_component,
            platform::invoke_component_command,
            platform::route_file_intent,
            platform::get_file_routing_snapshot,
            platform::set_file_association_binding,
            ...
            platform::get_development_component_snapshot,
            platform::trust_script_development_directory,
            platform::untrust_script_development_directory,
            platform::reload_script_component,
            platform::reload_development_interface_template,
            platform::reload_development_components,
            platform::create_script_component_template,
            platform::open_script_development_directory_in_vscode,
